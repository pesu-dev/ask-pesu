...
sys.stdout.write("// This file is GENERATED by buildMetrics.sh. DO NOT MODIFY.\n")
sep = "export default {\n    "
for font in sorted(data):
    ...
    for glyph in sorted(data[font], key=int):
        ...
        values = [value if value != 0.0 else 0 for value in [data[font][glyph][key] for key in props]]
